...
Each preset sets both how long a press takes and how deep it goes, because
overshoot is a proportion of the distance travelled — a spring that bounces
half as far again as a 4% press moves less than a pixel and reads as no bounce
at all.
...
| -------- | ---------- | ---------- | ---------- |
| `smooth` | 285ms      | 0.96       | none       |
| `snappy` | 120ms      | 0.94       | slight     |
| `bouncy` | 901ms      | 0.88       | pronounced |
| `none`   | instant    | 1          | none       |
